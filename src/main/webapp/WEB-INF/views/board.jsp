      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="#"><i class="fa fa-users-cog fa-fw"></i>&nbsp; 사용자 관리</a>
            <a class="collapse-item" href="#"><i class="fa fa-user-clock"></i>&nbsp; 로그인 이력</a>
          </div>
        </div>
      </li>
    </ul>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <span class="h2 mb-2 text-gray-800">게시판</span>
            </div>
          </form>
          ...
          <ul class="navbar-nav ml-auto">    
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="text-gray-800" style="font-weight:bold">사용자 이름  <i class="fa fa-user fa-fw" ></i></span>                
              </a>
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="#">
                  <i class="fas fa-history fa-sm fa-fw mr-2 text-gray-800"></i>
                  	로그기록
                </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Gi-ENS 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
